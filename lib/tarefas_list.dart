...
class TarefasList extends StatelessWidget {
  ...
  const TarefasList({required this.state});
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ValueNotifier<bool> concluido =
            ValueNotifier(tarefas[index].concluido != null);
        return ListTile(
          onTap: () async {
            await Navigator.of(context)
                .pushNamed("/edit", arguments: tarefas[index]);
            state.carregarLista();
          },
              ...
              builder: (context, value, widget) {
                return Checkbox(
                    ...
                    onChanged: (value) {
                      ...
                      tarefa.concluido =
                          concluido.value ? DateTime.now() : null;
                      state.salvar(tarefa);
